        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="detail-box">
                    ...
                    <h4 style="color:red; margin:15px 0;">{{ $product->price }} VNĐ</h4>
                    ...
                    <div style="margin:20px 0;">
                        ...
                        <input type="number" name="quantity" value="1" min="1" style="width:70px;" form="addToCartForm">
                    </div>

                    <form action="{{ route('cart.add', $product->id) }}" method="GET" class="d-inline">
                        <input type="number" name="quantity" value="1" min="1" style="width:70px;" hidden>
